...
#os.system("gcc ode.c -o ode.exe")
#os.system("ode.exe")
#os.system("gcc odempi.c -o odempi.out -lm")
#os.system("./ode.out")
os.system("mpicc odempi.c -o odempi.out -lm")
os.system("mpirun -np 3 ./odempi.out")

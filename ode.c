...
double RHS_J_1 (double m3, double x1,  double y1, double ux1, double uy1)//Dimensionless Newton's 2st Law equation for Jupiter
{
    return ux1;
}

double RHS_J_2 (double m3, double x1,  double y1, double ux1, double uy1)
{
    return -m3*x1/(pow(x1*x1 + y1*y1, 1.5));
}

double RHS_J_3 (double m3, double x1,  double y1, double ux1, double uy1)
{
    return uy1;
}

double RHS_J_4 (double m3, double x1,  double y1, double ux1, double uy1)
{
...
int main()
{
    ...
    for (k = 0; k <= num; k++)
    {
        R_output[k]=RK4_asteroid(N,  m_Sun, m_J,  dt,  k,
                x_J, y_J,
                k1_x_J,  k1_y_J, 
                k2_x_J,  k2_y_J, 
                k3_x_J,  k3_y_J,
